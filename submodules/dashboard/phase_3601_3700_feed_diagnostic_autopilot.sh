#!/bin/bash
echo "🧠 Phase 3601–3700: Feed Diagnostic & AutoFix"
echo "--------------------------------------------"

mkdir -p logs config ai/providers

cat > ai/providers/feed_diagnostic.py <<'EOF'
...
echo "✅ Diagnostic Python script ready."

# 3️⃣ Run diagnostic
source venv/bin/activate
python3 ai/providers/feed_diagnostic.py

# 4️⃣ Auto-regenerate signals
python3 ai/signal_engine.py

echo "📊 Diagnostics + signal regeneration done."
